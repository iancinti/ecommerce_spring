...
public class CartServiceImpl implements CartService {
    ...
    public void setProductQuantity(String cartId, String productId, int quantity) {
        List<CartItem> list = (List<CartItem>) cache.getList(cartId, CartItem.class);
    ...
    public Set<CartItem> getItems(String cartId) {
        return new HashSet<>((List<CartItem>) cache.getList(cartId, CartItem.class));
    }

    @Override
    public Order createOrder(String cartId, Order order) {
        List<CartItem> cartItems = (List<CartItem>) cache.getList(cartId, CartItem.class);
